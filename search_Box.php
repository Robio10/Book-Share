                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form class="form-wrapper cf" action="search.php" autocomplete="on" method = "post" >
	                            <input id="bookname" name="bookname" type="text" placeholder="Enter Book name here..." onblur="this.value=this.value.toUpperCase()" required>
	                            <p "class="pos_left"> 
